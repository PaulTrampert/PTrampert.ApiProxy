...
namespace PTrampert.ApiProxy.Test
{
    class TestHttpHandler : HttpMessageHandler
    {
        ...
        /// </summary>
        public IDictionary<string, string[]> LastRequestHeaders { get; private set; } = new Dictionary<string, string[]>();
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            LastRequestHeaders = request.Headers.ToDictionary(h => h.Key, h => h.Value.ToArray());
